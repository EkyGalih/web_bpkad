                ...
                <div class="tab-pane fade {{ $Pshow }} {{ $Pactive }}" id="permohonan" role="tabpanel"
                    ...
                    <form action="{{ route('faq.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @error('telepon')
                            <div class="alert alert-danger" style="padding: 8px;">{{ $message }}</div>
                        @enderror
                        <input class="form-control @error('pekerjaan') is-invalid @enderror" value="{{ old('pekerjaan') }}"
                            type="text" style="margin-bottom: 15px;" name="pekerjaan" placeholder="Pekerjaan">
                        @error('pekerjaan')
                            <div class="alert alert-danger" style="padding: 8px;">{{ $message }}</div>
                        @enderror
                ...
                <div class="tab-pane fade {{ $Lshow }} {{ $Lactive }}" id="pengaduan" role="tabpanel"
                    ...
                    <form action="{{ route('faq.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <select class="form-control @error('kategori_laporan') is-invalid @enderror"
                            style="margin-bottom: 15px;" value="{{ old('kategori_laporan') }}" name="kategori_laporan">
