        ...
        <div class="container pt-17 pb-19 pt-md-18 pb-md-17 text-center">
            <div class="row">
                <div class="col-lg-8 col-xl-7 col-xxl-6 mx-auto">
                    ...
                    <p class="lead px-lg-5 px-xxl-8 mb-1 text-white">Semua berita terkait agenda & kegiatan BPKAD Provinsi
                        NTB.</p>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="post-header">
                                                ...
                                                <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark"
                                                        href="{{ route('post.show', [PostCategory($post->posts_category_id), $post->slug]) }}">{{ substr($post->title, 0, 50) }}</a>
                                                </h2>
                                            </div>
                                            <div class="post-content">
