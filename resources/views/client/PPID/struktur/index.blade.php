                            ...
                            <div class="swiper-slide">
                                <div class="blockquote-details">
                                    <div class="info ps-0">
                                        ...
                                        <p class="mb-0">{{ strtoupper($atasan->nama_jabatan) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <img class="img-thumbnail w-35 mb-4" src="{{ asset($kepala_pengelola->foto) }}"
                                            srcset="{{ asset($kepala_pengelola->foto) }}" alt="{{ $kepala_pengelola->name }}" />
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <img class="img-thumbnail w-35 mb-4" src="{{ asset($kepala_pengaduan->foto) }}"
                                            srcset="{{ asset($kepala_pengaduan->foto) }}" alt="{{ $kepala_pengaduan->name }}" />
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <img class="img-thumbnail w-35 mb-4" src="{{ asset($kepala_pelayanan->foto) }}"
                                            srcset="{{ asset($kepala_pelayanan->foto) }}" alt="{{ $kepala_pelayanan->name }}" />
