                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <a href="#" class="btn btn-outline-primary btn-md"
                                        ...
                                        <i class="bi bi-journal-plus"></i> Tambah Mennu
                                    </a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($menus as $menu)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('pages-admin.edit', $menu->id) }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Halaman <strong><u>{{ $menu->title }}</u></strong>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="{{ route('pages-admin.destroy', $menu->id) }}" class="btn btn-outline-danger">
