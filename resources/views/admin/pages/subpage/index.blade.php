            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#CacheSubPages" data-bs-tooltip="tooltip"
                            data-bs-placement="top" title="Tong Sampah" class="btn btn-danger btn-md">
                            <i class="icon-base ri ri-delete-bin-3-fill icon-18px"></i>
                        </button>
                    </div>
                </div>
                @include('admin.pages.subpage.addons._cache')
            </div>
            <div class="card-datatable table-responsive text-nowrap">
                <div class="table-responsive">
                    <table class="table table-bordered table-responsive subpage">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Judul</th>
                        ...
                        <tbody>
                            @foreach ($subpages as $page)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($page->created_at_at)->locale('id')->isoFormat('dddd, D MMMM YYYY') }}
                                    </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('subpages-admin.edit', $page->id) }}"><i
                                                        class="icon-base ri ri-pencil-line icon-18px me-2"></i> Edit</a>
                                                <button class="dropdown-item"
                                                    onclick="trashData('{{ route('subpages-admin.destroy', $page->id) }}')"><i
