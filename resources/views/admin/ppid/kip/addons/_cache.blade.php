                        ...
                        @else
                            @foreach ($DeletedKIP as $del)
                                <tr>
                                    ...
                                    <td><span
                                            class="badge bg-{{ $del->jenis_file == 'link' ? 'secondary' : 'info' }}"><i
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('ppid-kip.delete', $del->id) }}"
                                            onclick="return confirm('apakah anda yakin?')" class="btn btn-danger btn-md"
                                            data-bs-tooltip="tooltip" data-bs-placement="top" title="Hapus Permanen">
