        ...
        <div class="card" id="card-subpage">
            ...
            <form action="{{ route('ppid-kip.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-floating form-floating-outline mb-6 {{ old('jenis_file') == 'link' ? 'show' : '' }}" id="link-file-group">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end gap-2">
                            <button class="btn btn-outline-secondary btn-lg" style="float: right;" type="reset">
