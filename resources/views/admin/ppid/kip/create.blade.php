            ...
            <form action="{{ route('kip.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline mb-3">
                                <input class="form-control" name="created_at" value="{{ old('created_at') }}" type="datetime-local" id="waktu_upload" />
                                <label for="waktu_upload">Waktu Upload</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating form-floating-outline mb-3">
                    ...
                    <div class="form-floating form-floating-outline mb-6 {{ old('jenis_file') == 'link' ? 'show' : '' }}"
                        ...
                        <input id="link" type="text" name="links_file" placeholder="Link"
                            class="form-control @error('links_file') is-invalid @enderror"
                            value="{{ old('links_file') }}">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button class="btn btn-success btn-lg" style="float: right; margin-right: 2px;"
                                type="submit">
