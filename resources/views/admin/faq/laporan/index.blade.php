                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($lap->jawaban == null)
                                                    <button class="btn btn-secondary btn-sm" data-bs-tooltip="tooltip"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#Jawab{{ $loop->iteration }}"><i
                                                            class="bi bi-pencil"></i> Jawab</button>
                                                    @include('admin/faq/laporan/addons/_jawab')
                                                @else
                                                    <button class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#ShowJawaban{{ $loop->iteration }}">Lihat
                                                        Jawaban</button>
                                            ...
                                            <td>
                                                <button type="submit" data-bs-toggle="modal"
                                                    data-bs-target="#EditMenu{{ $loop->iteration }}"
                                                    class="btn btn-warning btn-md">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>

                                                @include('admin/faq/laporan/addons/_edit')
