<div class="modal fade" id="EditVideo{{ $loop->iteration }}" tabindex="-1" aria-labelledby="EditVideoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="EditVideoLabel">Edit Galery</h5>
            ...
            <form method="POST" action="{{ route('galery.update', $galery->id) }}">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" value="2" name="galery_type_id">
