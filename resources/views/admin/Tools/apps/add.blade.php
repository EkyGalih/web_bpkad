                ...
                <div class="card-body">
                    ...
                    <div class="row form-floating form-floating-outline mb-6">
                        <input type="text" id="versi" placeholder="Versi Aplikasi (misal: 1.01)" name="versi"
                            class="form-control" pattern="^\d+(\.\d+)?$" title="Masukkan versi dengan format angka, misal: 1.01">
                        <label for="versi">Versi Aplikasi</label>
                    </div>
                    <div class="row form-floating form-floating-outline mb-6">
                        <textarea id="deskripsi" placeholder="Deskripsi" name="deskripsi" class="form-control"></textarea>
                    ...
                    <div class="row form-floating form-floating-outline mb-6">
                        ...
                        <div class="col-md-4">
                            <img id="blah" src="{{ asset('static/images/no_image.png') }}" height="150" width="150" alt="your image" />
                        </div>
                    </div>
                </div>
