            ...
            <table class="post table table-bordered table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ get_date($post->created_at) }}</td>
                        <td>{{ $post->updated_at == null ? 'None' : get_date($post->updated_at) }}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="{{ route('post-admin.agenda', $post->id) }}" class="dropdown-item"
                                        data-bs-tooltip="tooltip" data-bs-placement="top" title="Jadikan Agenda Kaban">
                                        <i
                                    ...
                                    <button class="dropdown-item" data-bs-toggle="modal"
                                        data-bs-target="#DeletePost{{ $loop->iteration }}"><i
