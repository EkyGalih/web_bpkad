    ...
    <div class="container py-13 pb-md-15">
        ...
        <div class="row gy-6 gy-lg-0">
            <div class="col-md-4 col-lg-3">
                <div class="widget">
                    <img class="mb-4" src="{{ asset('client/assets/img/logo-dark.png') }}" srcset="{{ asset('client/assets/img/logo-dark@2x.png 2x') }}"
                        alt="" />
                    <p class="mb-4">© <script>
            ...
            <div class="col-md-12 col-lg-3">
                <div class="widget">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4854.364344670461!2d116.1078112758967!3d-8.58309358711536!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcdc09f19da683b%3A0x9f800d0a99b1a506!2sKantor%20BPKAD%20NTB!5e1!3m2!1sen!2sid!4v1747878316576!5m2!1sen!2sid" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <!-- /.widget -->
            </div>
            <!-- /column -->
