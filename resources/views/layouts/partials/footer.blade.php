{{-- <div class="container py-4">
    <div class="copyright">
        &copy; 2017-{{ date('Y') }} <strong><span>ITeam BPKAD</span></strong>. All Rights Reserved
    </div>
</div> --}}
<footer class="landing-footer">
    <div class="footer-top position-relative overflow-hidden">
        <img src="{{ asset('server/assets/img/front-pages/backgrounds/footer-bg.png') }}" alt="footer bg"
        ...
        <div
            ...
            <div class="mb-2 mb-md-0">
                ...
                <a href="#" target="_blank"
                    class="footer-link fw-medium footer-theme-link">ITeam BPKAD</a>
            </div>
        </div>
    </div>
</footer>