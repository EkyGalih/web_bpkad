                    ...
                    @foreach ($laporan as $lap)
                        <li class="notification-item">
                            ...
                            <div>
                                ...
                                <p><span class="badge bg-secondary">{{ RangeTime($lap->created_at) }}</span>
                                </p>
                            </div>
                        </li>
                        ...
                        <li class="message-item">
                            <a href="#">
                                ...
                                <div>
                                    ...
                                    <p><span
                                            class="badge bg-secondary">{{ RangeTime($item->created_at) }}</span>
                                        <span
                                            class="{{ NewData($item->created_at) == 'false' ? '' : 'blink' }}"
                                            style="font-size: 8px;">{{ NewData($item->created_at) == 'true' ? 'Baru' : '' }}</span>
                                    </p>
                                </div>
                            </a>
                        </li>
