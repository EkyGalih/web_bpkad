...
<html lang="id">
	...
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="Laporan Keuangan Pemerintah Daerah (LKPD) Badan Pengawasan Keuangan dan Pembangunan (BPKAD) Provinsi Nusa Tenggara Barat" />
		<meta name="keywords" content="LKPD, BPKAD, Laporan Keuangan, Nusa Tenggara Barat, NTB, Mataram" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="id_ID" />
		<meta property="og:type" content="website" />
		<meta property="og:title" content="LKPD BPKAD Provinsi Nusa Tenggara Barat" />
		<meta property="og:url" content="{{ ENV('APP_URL') }}/admin/lkpd" />
		<meta property="og:site_name" content="LKPD BPKAD" />
		@include('layouts.admin.lkpd.css')
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				<!--begin::Header-->
				@include('layouts.admin.lkpd.header')
				<!--end::Header-->
				<!--begin::Wrapper-->
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
							...
							<div class="d-flex flex-column flex-row-fluid">
								...
								<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-13 pb-6">
									...
									<div class="page-title me-5">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-white fw-bold fs-2 flex-column justify-content-center my-0">Welcome back, {{ Auth::user()->nama }}
										<!--begin::Description-->
					...
					<div class="app-container container-xxl">
						...
						<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
											...
											<div class="card mb-5 mb-xl-8">
												...
												<div class="card-header align-items-center border-0 mt-4">
													...
													<div class="card-toolbar">
														...
														<!--begin::Menu 1-->
														<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_673c26059a799">
															<!--begin::Header-->
															<div class="px-7 py-5">
															...
															<div class="px-7 py-5">
																...
																<div class="mb-10">
																	...
																	<!--begin::Input-->
																	<div>
																		<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_673c26059a799" data-allow-clear="true">
																			<option></option>
							...
							<!--end::Content wrapper-->
							<!--begin::Footer-->
							@include('layouts.admin.lkpd.footer')
							<!--end::Footer-->
						</div>
						<!--end:::Main-->
					</div>
