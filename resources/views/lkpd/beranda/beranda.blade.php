                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" multiple="multiple"
                                            ...
                                            data-placeholder="Select option" data-dropdown-parent="#kt_menu_673c26059a799"
                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex flex-stack mb-9">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <div class="symbol-label bg-light">
                                                <img src="assets/media/svg/brand-logos/telegram-2.svg" class="h-50"
                                                    alt="" />
                                            </div>
                                        </div>
                                        <!--end::Symbol-->
                                        ...
                                        <div>
                                            <a href="#"
                                                class="fs-6 text-gray-800 text-hover-primary fw-bold">Binford Ltd.</a>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Biffco
                                                Enterprises</a>
