            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('ppid-op-kip.index') }}">PPID</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr />
                            <form action="{{ route('ppid-op-kip.update', $kip->id) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12">
                                        <a href="{{ route('ppid-op-kip.index') }}" class="btn btn-secondary btn-md"
                                            style="float: right;">
