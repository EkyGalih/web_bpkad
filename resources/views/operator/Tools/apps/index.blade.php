        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <a href="{{ route('apps-op.create') }}" class="btn btn-outline-primary btn-md" style="float: right; margin-bottom: 5px;">
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('apps-op.edit', $app->id) }}" class="btn btn-outline-warning brn-md">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-outline-secondary"
                                                        ...
                                                        Tidak</button>
                                                    <a href="{{ route('apps-op.destroy', $app->id) }}"
