...
class AppsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('operator.Tools.apps.index', compact('apps'));
    }
    ...
    {
        return view('operator.Tools.apps.add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.Tools.apps.edit', compact('app'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('apps-op.index')->with(['success' => 'Apps berhasil diubah!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('apps-op.index')->with(['success' => 'Apps berhasil dihapus!']);
    }
}
