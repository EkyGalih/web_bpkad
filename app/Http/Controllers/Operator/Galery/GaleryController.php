...
class GaleryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('operator.galery.index', compact('fotos', 'videos'));
    }
    ...
    {
        return view('operator.galery.foto.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->jenis_video == 'non-upload') {
            ...
            Helpers::_recentAdd($id, 'membuat galery', 'galery');
            return redirect()->route('Gfoto-op.create', $id)->with(['success' => 'Galery berhasil ditambahkan!']);
        }
    }
