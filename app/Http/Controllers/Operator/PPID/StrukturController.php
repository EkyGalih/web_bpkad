...
class StrukturController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('operator.ppid.struktural.index', compact('struktural'));
    }
    ...
    public function create()
    {
        ...
        return view('operator.ppid.struktural.components.create', compact('pegawais', 'jabatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ppid-op-struktur.index')->with(['success' => 'Pejabat berhasil ditambah!']);
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.ppid.struktural.components.edit', compact('pegawais', 'struktur', 'jabatan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ppid-op-struktur.index')->with(['success' => 'Pejabat berhasil diubah!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('ppid-op-struktur.index')->with(['success' => 'Pejabat berhasil dihapus!']);
    }
}
